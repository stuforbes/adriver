...
public class AllChildrenProbeTest {
    ...
    public void initialise() {
        ...
        this.probe = new AllChildrenProbe(by, parent, operator, elementFactory);
    }
    ...
    public void describeFailureDescribesTheProbesFailure() {
        ...
        assertThat(
                ...
                is("Expected at least one element under element parent-element with criteria by id=an-id, but instead found 0"));
    }
}
