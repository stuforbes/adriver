...
public class CountdownChildProbeTest {
    ...
    public void initialise() {
        ...
        this.probe = new CountdownChildProbe(by, parent, CollectionSizes.equalTo(EXPECTED_COUNT), operator,
                elementFactory);
    }
    ...
    public void probeOperatesOnAllChildren() {
        ...
        final Sequence countdownChildSequence = context.sequence("countdownChildSequence");
        ...
        context.checking(new Expectations() {
            {
                ...
                inSequence(countdownChildSequence);
